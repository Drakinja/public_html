...
function buy(store) {
    ...
    if (store.getAttribute("name") === "Blue-Gompei") {
        const blue_gompei = document.querySelector("#widget-container #blue-gompei")?.parentElement;
        // If blue-Gompei already exists
        if (blue_gompei) {

        blue_gompei_count += 1;
        document.body.style = "--gompei-count: " + blue_gompei_count + ";"
           
        blue_gompei.setAttribute("reap", (parseInt(blue_gompei.getAttribute("reap")) + 90));
            return;
        }
